...
class _ZoomableWidgetState extends State<ZoomableWidget> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return new CustomMultiChildLayout(delegate: new _ZoomableWidgetLayout(), children: <Widget>[
      new LayoutId(
  ...
  Widget _child(Widget _child) {
    return new Transform(
      ...
      child: new Transform(
        transform: new Matrix4.identity()..translate(_panOffset.dx, _panOffset.dy),
        child: _child,
      ),
    );
  }
